<template>
    <div class="act-img-config">
        <div>
            ...
            <div class=" act-img-config-field">
                ...
                <el-form-item label="宽度">
                    <el-input-number v-model="data.params.width" :step="10" placeholder="宽度">
                    </el-input-number>
                </el-form-item>
        ...
        <div v-for="(item, index) in data.params.bannerList" :key="index">
            <div class="act-img-config-flex">
                <p class="act-img-config-title">图文广告{{ index + 1 }}</p>
...
<script>
import banner from '@/assets/coupon/images.png'
...
export default {
    ...
    methods: {
        addBanner() {
            console.log(this.data.params.bannerList)
